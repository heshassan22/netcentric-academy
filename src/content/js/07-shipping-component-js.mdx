...
<Callout type="note">**In the example** (`examples/js-component`): `accordion.clientlibs.js` `[07]` + `accordion.html` — the clientlib category that loads the CSS/JS, booted by the global `run()`/`observe()`.</Callout>
